...
With {TSFShortName} deployed, you need to verify that all components are running correctly and accessible. In this module, you will check each component, access the Konflux UI, and explore the architecture that TechCorp Industries now has in place for their secure software supply chain.
...
In this module, you verified your {TSFShortName} deployment:
...
Click *Next* to continue to Module 4 and build your first secure application.
