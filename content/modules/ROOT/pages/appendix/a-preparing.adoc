...
[NOTE]
====
These exercises duplicate xref:03-module-01-preparing.adoc[Module 1: Preparing to install]; use whichever path fits your agenda. If you already completed Module 1 in the workshop, you can xref:appendix/b-installing.adoc[Appendix B: Installing {TSFShortName}] when your `tsf.env` is ready.
====
