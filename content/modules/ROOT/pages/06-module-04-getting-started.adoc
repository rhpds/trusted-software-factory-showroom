...
If you used the TSF catalog item, a sample repository is available in the tsf group of the local GitLab repository.
...
+
----
https://<github_or_gitlab_fqdn>/<your-org>/sample-component-golang
----
+
